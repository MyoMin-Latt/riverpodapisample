...
class _$DimensionsModelImpl extends _DimensionsModel {
...
/// @nodoc
abstract class _$$ReviewsModelImplCopyWith<$Res>
    implements $ReviewsModelCopyWith<$Res> {
  factory _$$ReviewsModelImplCopyWith(
          _$ReviewsModelImpl value, $Res Function(_$ReviewsModelImpl) then) =
      __$$ReviewsModelImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {int rating,
...
/// @nodoc
class __$$ReviewsModelImplCopyWithImpl<$Res>
    extends _$ReviewsModelCopyWithImpl<$Res, _$ReviewsModelImpl>
    implements _$$ReviewsModelImplCopyWith<$Res> {
  __$$ReviewsModelImplCopyWithImpl(
      _$ReviewsModelImpl _value, $Res Function(_$ReviewsModelImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$ReviewsModelImpl(
      rating: null == rating
          ? _value.rating
          : rating // ignore: cast_nullable_to_non_nullable
              as int,
...
class _$ReviewsModelImpl extends _ReviewsModel {
  const _$ReviewsModelImpl(
  ...
  @override
  String toString() {
    return 'ReviewsModel(rating: $rating, comment: $comment, date: $date, reviewerName: $reviewerName, reviewerEmail: $reviewerEmail)';
  }
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$ReviewsModelImplCopyWith<_$ReviewsModelImpl> get copyWith =>
      __$$ReviewsModelImplCopyWithImpl<_$ReviewsModelImpl>(this, _$identity);
}
...
abstract class _ReviewsModel extends ReviewsModel {
  const factory _ReviewsModel(
      ...
      required final String reviewerEmail}) = _$ReviewsModelImpl;
...
class _$ProductsModelImpl extends _ProductsModel {
  ...
  @override
  String toString() {
    return 'ProductsModel(id: $id, title: $title, description: $description, category: $category, price: $price, discountPercentage: $discountPercentage, rating: $rating, stock: $stock, tags: $tags, brand: $brand, sku: $sku, weight: $weight, dimensions: $dimensions, warrantyInformation: $warrantyInformation, shippingInformation: $shippingInformation, availabilityStatus: $availabilityStatus, reviews: $reviews, returnPolicy: $returnPolicy, minimumOrderQuantity: $minimumOrderQuantity, meta: $meta, images: $images, thumbnail: $thumbnail)';
  }
...
abstract class _ProductsModel extends ProductsModel {
  const factory _ProductsModel(
      ...
      required final List<String> images,
      required final String thumbnail}) = _$ProductsModelImpl;
...
mixin _$ProductsAllModel {
  ...
  @JsonKey(ignore: true)
  $ProductsAllModelCopyWith<ProductsAllModel> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $ProductsAllModelCopyWith<$Res> {
  factory $ProductsAllModelCopyWith(
          ProductsAllModel value, $Res Function(ProductsAllModel) then) =
      _$ProductsAllModelCopyWithImpl<$Res, ProductsAllModel>;
  @useResult
  $Res call({List<ProductsModel> products, int total, int skip, int limit});
}

/// @nodoc
class _$ProductsAllModelCopyWithImpl<$Res, $Val extends ProductsAllModel>
    implements $ProductsAllModelCopyWith<$Res> {
  _$ProductsAllModelCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$ProductsAllModelImplCopyWith<$Res>
    implements $ProductsAllModelCopyWith<$Res> {
  factory _$$ProductsAllModelImplCopyWith(_$ProductsAllModelImpl value,
          $Res Function(_$ProductsAllModelImpl) then) =
      __$$ProductsAllModelImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call({List<ProductsModel> products, int total, int skip, int limit});
}
...
/// @nodoc
class __$$ProductsAllModelImplCopyWithImpl<$Res>
    extends _$ProductsAllModelCopyWithImpl<$Res, _$ProductsAllModelImpl>
    implements _$$ProductsAllModelImplCopyWith<$Res> {
  __$$ProductsAllModelImplCopyWithImpl(_$ProductsAllModelImpl _value,
      $Res Function(_$ProductsAllModelImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$ProductsAllModelImpl(
      products: null == products
          ? _value._products
          : products // ignore: cast_nullable_to_non_nullable
              as List<ProductsModel>,
...
class _$ProductsAllModelImpl extends _ProductsAllModel {
  const _$ProductsAllModelImpl(
  ...
  @override
  String toString() {
    return 'ProductsAllModel(products: $products, total: $total, skip: $skip, limit: $limit)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$ProductsAllModelImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$ProductsAllModelImplCopyWith<_$ProductsAllModelImpl> get copyWith =>
      __$$ProductsAllModelImplCopyWithImpl<_$ProductsAllModelImpl>(
          this, _$identity);
}

abstract class _ProductsAllModel extends ProductsAllModel {
  const factory _ProductsAllModel(
      {required final List<ProductsModel> products,
      required final int total,
      required final int skip,
      required final int limit}) = _$ProductsAllModelImpl;
  const _ProductsAllModel._() : super._();
