...
class _$UsersModelImpl implements _UsersModel {
  ...
  @override
  String toString() {
    return 'UsersModel(id: $id, name: $name, username: $username, email: $email, phone: $phone, website: $website, address: $address, company: $company)';
  }
...
abstract class _UsersModel implements UsersModel {
  const factory _UsersModel(
      ...
      required final CompanyModel company}) = _$UsersModelImpl;
...
class _$GeoModelImpl implements _GeoModel {
  _$GeoModelImpl({required this.lat, required this.lng});
