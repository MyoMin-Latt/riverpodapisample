...
class _$UsersModelImpl implements _UsersModel {
  ...
  @override
  String toString() {
    return 'UsersModel(id: $id, name: $name, username: $username, email: $email, phone: $phone, website: $website, company: $company)';
  }
...
abstract class _UsersModel implements UsersModel {
  const factory _UsersModel(
      ...
      required final Company company}) = _$UsersModelImpl;
